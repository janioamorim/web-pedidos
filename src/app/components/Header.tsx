    ...
    return (
      <header className="bg-white shadow-md p-6 flex justify-end items-right">
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center justify-items-center ml-2 gap-3 cursor-pointer" onClick={() => {handleMenu()}}>
            <div className="flex flex-col w-full items-end">
              <span className=" color-gray-100">Olá,</span>
              <span className="font-semibold color-gray-100 text-align" >{ user }</span>
            </div>
